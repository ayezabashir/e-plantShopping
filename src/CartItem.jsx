...
import PropTypes from "prop-types"; // Added for ESLint validation
import "./CartItem.css";
...
const CartItem = ({ onContinueShopping }) => {
  ...
  // Helper to convert "$15" string to 15 number
  ...
  const handleDecrement = (item) => {
    if (item.quantity > 1) {
      ...
      // If it reaches 0, remove it entirely to re-enable "Add to Cart"
...
// Fixed ESLint 'prop-types' missing error
CartItem.propTypes = {
